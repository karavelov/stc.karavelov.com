"""
Django settings for stcsys project.
...
ROOT_URLCONF = 'stcsys.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['/var/www/karavelov/stc/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'stcsys.wsgi.application'
...
PASSWORD_HASHERS = [
    'django.contrib.auth.hashers.BCryptPasswordHasher',  # ✅ Чист bcrypt без SHA256
...
CSRF_TRUSTED_ORIGINS = ['https://stc.karavelov.com']

AUTHENTICATION_BACKENDS = [
    'cmsapp.EmailBackEnd.EmailBackEnd',  # ✅ Добави този ред
